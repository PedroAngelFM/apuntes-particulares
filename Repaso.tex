...
\addcontentsline{toc}{chapter}{Introducción}%para a�adir al �ndice la secci�n no numerada 
...
\\
%%Mirar como se hace esto correctamente, los ejercicios no son los definitivos
\begin{tabular}{r l}
